...
RUN wget https://dlcdn.apache.org/tomcat/tomcat-10/v10.1.7/bin/apache-tomcat-10.1.7.tar.gz --no-check-certificate
...
ADD  target/simple-app-3.0.0-SNAPSHOT.war  /opt/tomcat/webapps/simple-app-3.0.0-SNAPSHOT.war
EXPOSE 8080
